...
public static class GetSkyrimData
{
    public static DataTable GetWeapon(bool trimString = false, int maxLength = 0)
    {
        ...
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Weapon().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.AcousticSpace().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.ActionRecord().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Activator().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    public static DataTable GetActorValueInformation(bool trimString = false, int maxLength = 0)
    {
        ...
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.ActorValueInformation().WinningOverrides(),
            trimString, maxLength);
    }

    public static DataTable GetAddonNode(bool trimString = false, int maxLength = 0)
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.AddonNode().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Ammunition().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.AnimatedObject().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.APlacedTrap().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Armor().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.ArmorAddon().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.ArtObject().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.AssociationType().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.BodyPartData().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Book().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.CameraPath().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.CameraShot().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Cell().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Class().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Climate().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.CollisionLayer().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.ColorRecord().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.CombatStyle().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Container().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Debris().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.DialogBranch().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.DialogResponses().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.DialogTopic().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.DialogView().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Door().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.DualCastData().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.EffectShader().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.EncounterZone().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.EquipType().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Explosion().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Eyes().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Faction().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Flora().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Footstep().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.FootstepSet().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.FormList().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Furniture().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.GameSetting().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Global().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Grass().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Hair().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Hazard().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.HeadPart().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.IAliasVoiceType().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.IConstructible().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.IdleAnimation().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.IdleMarker().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.IEffectRecord().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.IEmittance().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.IExplodeSpawn().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.IHarvestTarget().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.IIdleRelation().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.IItem().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.IItemOrList().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.IKnowable().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.ILockList().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.ImageSpace().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.IMagicItem().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Impact().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.ImpactDataSet().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Ingestible().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Ingredient().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.INpcOrList().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.INpcSpawn().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.IObjectId().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.IOutfitTarget().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.IOwner().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.IPlaced().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.IPlacedSimple().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.IPlacedThing().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.IRegionTarget().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.IRelatable().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.ISound().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.ISpellOrList().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.ISpellRecord().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.IWeaponOrList().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Keyword().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Landscape().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.LensFlare().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.LeveledItem().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.LeveledNpc().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.LeveledSpell().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Light().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.LoadScreen().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Location().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.MagicEffect().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.MaterialObject().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.MaterialType().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Message().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.MiscItem().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.MoveableStatic().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.MovementType().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.MusicTrack().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.MusicType().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.NavigationMesh().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.ObjectEffect().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Outfit().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Package().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Perk().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.PlacedNpc().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.PlacedObject().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Projectile().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Quest().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Race().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Region().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Relationship().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Scene().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Scroll().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Shout().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.SoulGem().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.SoundCategory().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.SoundDescriptor().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.SoundMarker().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Spell().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Static().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.TextureSet().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Tree().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.VisualEffect().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.VoiceType().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Water().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Weather().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.WordOfPower().WinningOverrides(), trimString,
            maxLength);
    }
    ...
    {
        using var env = GameEnvironment.Typical.Skyrim(SkyrimRelease.SkyrimSE);
        return CreateDataTable.CreateTable(env.LoadOrder.PriorityOrder.Worldspace().WinningOverrides(), trimString,
            maxLength);
    }
}