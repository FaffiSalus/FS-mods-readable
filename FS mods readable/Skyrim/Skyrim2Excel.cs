...
public static class Skyrim2Excel
{
    ...
    public static void FillActorValueInformation(string fileName)
    {
        ...
        var dataTable =
            GetSkyrimData.GetActorValueInformation(true, int.Parse(ConfigHandler.GetExcelCellLimit() ?? "0"));
        CreateAndFillExcelFile.CreateAndFill(fileName, sheetName, dataTable);
    }
    ...
    public static void FillDefaultObjectManager(string fileName)
    {
        ...
        var dataTable =
            GetSkyrimData.GetDefaultObjectManager(true, int.Parse(ConfigHandler.GetExcelCellLimit() ?? "0"));
        CreateAndFillExcelFile.CreateAndFill(fileName, sheetName, dataTable);
    }
    ...
    public static void FillLocationReferenceType(string fileName)
    {
        ...
        var dataTable =
            GetSkyrimData.GetLocationReferenceType(true, int.Parse(ConfigHandler.GetExcelCellLimit() ?? "0"));
        CreateAndFillExcelFile.CreateAndFill(fileName, sheetName, dataTable);
    }
    ...
    public static void FillNavigationMeshInfoMap(string fileName)
    {
        ...
        var dataTable =
            GetSkyrimData.GetNavigationMeshInfoMap(true, int.Parse(ConfigHandler.GetExcelCellLimit() ?? "0"));
        CreateAndFillExcelFile.CreateAndFill(fileName, sheetName, dataTable);
    }
    ...
    public static void FillShaderParticleGeometry(string fileName)
    {
        ...
        var dataTable =
            GetSkyrimData.GetShaderParticleGeometry(true, int.Parse(ConfigHandler.GetExcelCellLimit() ?? "0"));
        CreateAndFillExcelFile.CreateAndFill(fileName, sheetName, dataTable);
    }
